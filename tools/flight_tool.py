...
# Default origin when user says only destination, eg. "Singapore Trip"
# Change this if your deefault loc isn't Mumbai
DEFAULT_ORIGIN_IATA=os.getenv("DEFAULT_ORIGIN_IATA", "Mumbai")
...
def clean_text(text: str) -> str:
    ...
    stop_words = [
        "flight", "flights", "ticket", "tickets", "trip", "travel", "plan", "complete", "days", "day", "including", "hotel", "hotels", "sightseeing", "under", "budget", "info", "information"
    ]
...
if __name__ == "__main__":
    print(search_flights("Plan a 7 days Singapore trip from India"))
    print("\n" + "=" * 80 + "\n")
