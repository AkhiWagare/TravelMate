...
def get_database_url():
    ...
    if not database_url:
        raise ValueError("DATABASE_URL is missing. Please add your Render PostgreSQL External Databse URL to .env")
...
def itinerary_agent(state: TravelState):
    ...
    response = llm.invoke([
        SystemMessage(
            ...
            Prioritize practical schedules and reasonable budgets.
...
def final_agent(state: TravelState):
    ...
    response = llm.invoke([
        SystemMessage(
            content="""
            You are a professional AI travel planning and booking assistant.

            Your job is to create clear, practical, and well-structured travel
            responses using the information provided by the user and the
            available flight, hotel, and itinerary data.

            - Use the provided information accurately.
            - Do not invent flight schedules, hotel details, availability, or prices.
            - Clearly distinguish confirmed information from estimates.
            - If information is unavailable, state that clearly.
            - Make the response useful for real-world travel planning.
